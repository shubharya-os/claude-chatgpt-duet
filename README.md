...
stubs, and the **seventeen real bugs** the live runs found — including a signed-out CLI
...
194 tests, no network or credentials needed. CI on Python 3.9, 3.11 and 3.13.
